...
Viewer::set_param('title', 'Update Generated Object "'.Viewer::get_param('generated_object')['name'].'"');
				...
				<form method="post" role="form">
					<div class="box-body">
						<div class="form-group<?php if (Validator::has_error('name')): echo ' has-error'; endif; ?>">
							...
							<input name="name" id="name" type="text" class="form-control" value="<?php echo Inputter::get_sanitized('name', Viewer::get_param('generated_object')['name']); ?>">
							<?php if (Validator::has_error('name')): echo '<span class="help-block">'.Validator::get_error('name').'</span>'; endif; ?>
						</div>
					</div>

					<div class="box-footer">
						<button type="submit" class="btn btn-primary btn-flat">Update Generated Object</button>
					</div>
				</form>
			</div>
		</div>
